.. NiftySplit documentation master file, created by
...
`NiftySplit source code on CmicLab`_


.. _`NiftySplit source code on CmicLab`: https://cmiclab.cs.ucl.ac.uk/GIFT-Surg/NiftySplit
...
NiftySplit is released under the BSD-3 License.
Please see the LICENSE file in the `NiftySplit source code repository`_ for details.


Acknowledgements
----------------

NiftySplit was developed as part of the `GIFT-Surg`_ project, at the `Wellcome EPSRC Centre for Interventional and Surgical Sciences (WEISS)`_, and the `Translational Imaging Group (TIG)`_ in the `Centre for Medical Image Computing (CMIC)`_ at `University College London (UCL)`_.



.. _`Wellcome EPSRC Centre for Interventional and Surgical Sciences`: http://www.ucl.ac.uk/weiss
.. _`NiftySplit source code repository`: https://cmiclab.cs.ucl.ac.uk/CMIC/NiftySplit
