...
from niftysplit.utils.utilities import get_number_of_blocks, get_block_coordinate_range, \
...
class TestFileSplitter(unittest.TestCase):
    ...
    def test_get_suggested_block_size(self):
        self.assertEqual(get_suggested_block_size([5, 5, 5], [2, 2, 2]),
                         [3, 3, 3])
        self.assertEqual(get_suggested_block_size([5, 5, 5], [2, 3, 4]),
                         [3, 2, 2])
        self.assertEqual(get_suggested_block_size([99, 100, 101], [3, 4, 5]),
                         [33, 25, 21])
